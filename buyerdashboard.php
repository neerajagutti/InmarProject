  	...
  	<style type="text/css">
  		...
  		<script type="text/javascript">
			...
			var seller_index="";
  			...
  			sellersInformation();
  			$.post("getwalletmoneycustomer.php",{"email":buyer_email},
         	function(data){
              $("#walletmoney").text(data);
         	}
         	);
	...
	<div class="container-fluid" style="background-color: black">
	  	<div class="col-sm-6">
  			...
  			<div class="col-sm-5" style="text-align: right;">
  				<h3 id="useremail_id" style="color: white">
  					<?php
  						echo $_SESSION['useremail'];
  					?>
  				</h3>
	    		<a class='fas fa-wallet' style='font-size:30px;color:white'>Wallet</a><h4 id="walletmoney" style="color: white"></h4>
  			</div>
